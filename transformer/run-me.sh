...
if [ ! -e "model/vocab.enmy.yml" ]
then
    cat data/corpus.bpe.en data/corpus.bpe.my | $MARIAN_VOCAB --max-size 36000 > model/vocab.enmy.yml
fi
...
then
    $MARIAN_TRAIN \
        ...
        --train-sets data/corpus.bpe.en data/corpus.bpe.my \
        --max-length 100 \
        --vocabs model/vocab.enmy.yml model/vocab.enmy.yml \
        --mini-batch-fit -w 10000 --maxi-batch 1000 \
        --early-stopping 10 --cost-type=ce-mean-words \
        --valid-freq 5000 --save-freq 5000 --disp-freq 500 \
        --valid-metrics ce-mean-words perplexity translation \
        --valid-sets data/valid.bpe.en data/valid.bpe.my \
...
do
    cat data/$prefix.bpe.en \
        ...
        | ../tools/moses-scripts/scripts/tokenizer/detokenizer.perl -l my \
        > data/$prefix.my.output
done
...
../tools/moses-scripts/scripts/generic/multi-bleu-detok.perl data/test.en < data/test.my.output
